...
from dragon_star.sdk.dataloader import DataLoader
from dragon_star.sdk.client import HEClient, AppDefDTO
from dragon_star.sdk.appdata import AppData, AppEnvData, AppVersionData
...
def create_dataclass(name: str = typer.Argument(..., help="Name of the Dataclass"), 
    ...
    #
    s = f"""from dragon_star.sdk.models import BaseData, DataRef
...
def create_model(name: str = typer.Argument(..., help="Name of the Model"),
    ...
    #
    s = f"""from dragon_star.sdk.models import DataModel, DataRef
from dragon_star.models.data.{inflection.underscore(dataref)} import {inflection.camelize(dataref)}Data
...
def create_reward(name: str = typer.Argument(..., help="Name of the Reward"), 
    ...
    fpath = _get_models_paths().joinpath(f'{fname}.py')
    #
    s = f"""from dragon_star.sdk.models import DataModel
...
def create_quest(name: str = typer.Argument(..., help="Name of the Craft"), 
    ...
    fpath = _get_models_paths().joinpath(f'{fname}.py')
    #
    s = f"""from dragon_star.sdk.models import DataModel, str
